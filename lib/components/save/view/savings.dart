...
import 'package:sprout_mobile/components/save/controller/savings_controller.dart';
import 'package:sprout_mobile/components/save/view/locked_funds.dart';
import 'package:sprout_mobile/components/save/view/savings_details.dart';
import 'package:sprout_mobile/components/save/view/target_savings.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: WillPopScope(
            ...
            child: Obx((() =>
                savingsIncontroller.savings.isEmpty &&
                    ...
                    : ((!savingsIncontroller.isSavingsLoading.value &&
                        ...
                        ? Scaffold(
                            ...
                            onRefresh: savingsIncontroller.refreshData,
                            child: Stack(
                              children: <Widget>[
                                ListView(),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            InkWell(
                                                                              onTap: () => {
                                                                                savingsIncontroller.type.value = "LOCK"
                                                                              },
                                                                              child: Column(
                                                                                children: [
                                                                                  Row(
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      SvgPicture.asset(
                                                                                        savingsIncontroller.type.value == "LOCK" ? AppSvg.mark_green : AppSvg.mark_dot,
                                                                                        height: 20,
                                                                                      )
                                                                                    ],
                                                                                  ),
                                                                            ...
                                                                            InkWell(
                                                                              onTap: () => {
                                                                                savingsIncontroller.type.value = "TARGET"
                                                                              },
                                                                              child: Column(
                                                                                children: [
                                                                                  Row(
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      SvgPicture.asset(
                                                                                        savingsIncontroller.type.value == "TARGET" ? AppSvg.mark_green : AppSvg.mark_dot,
                                                                                        height: 20,
                                                                                      )
                                                                                    ],
                                                                                  ),
                                                                                  addVerticalSpace(5.h),
                                                                                  Text("Automate your savings for a future goal and earn interest while you do so.", style: theme.textTheme.subtitle2)
                                                                                ],
                                                                              ),
                                                                            ),
                                                                            savingsIncontroller.type.value != ""
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Padding(
                                                                                        ...
                                                                                        child: CustomButton(
                                                                                          ...
                                                                                          onTap: () {
                                                                                            pop();
                                                                                            if (savingsIncontroller.type.value == "LOCK") {
