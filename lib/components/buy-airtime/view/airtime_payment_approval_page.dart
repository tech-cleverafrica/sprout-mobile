...
class AirtimePaymentApprovalScreen extends StatelessWidget {
  AirtimePaymentApprovalScreen(
      {super.key,
      this.heading = "Successful",
      this.messages = "Airtime Purchase Successful",
      required this.trans});
                        ...
                        onTap: () async {
                          final pdfFile = await locator
                              ...
                              .generateAirtimeReceipt(
                                  ...
                                  trans.type.toString(),
                                  trans.phoneNumber.toString(),
                                  trans.serviceType!.split("_").join(" "),
                                  trans.ref.toString(),
