...
import 'package:sprout_mobile/components/profile/view/otp_screen.dart';
import 'package:sprout_mobile/public/screens/approval_page.dart';
...
class ChangePinController extends GetxController {
  ...
  changePin(Map<String, dynamic> model) async {
    AppResponse response = await locator.get<ProfileService>().changePin(model);
    if (response.status) {
      pushUntil(
          page: ApprovalScreen(
        containShare: false,
