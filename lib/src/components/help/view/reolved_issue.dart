...
class ResolvedIssueScreen extends StatefulWidget {
  ResolvedIssueScreen(
      {super.key, required this.issue, required this.refreshIssue});
  final void issue;
  final Function() refreshIssue;
  @override
  _ResolvedIssueScreenState createState() => _ResolvedIssueScreenState();
}

class _ResolvedIssueScreenState extends State<ResolvedIssueScreen> {
  @override
  void initState() {
    super.initState();
  }
