const String useBiometricAuth = "use_biometric_auth";
const String SECURED_USER_MAIL = "secured_user_mail";
const String SECURED_PASSWORD = "secured_password";
const String ISLOGGED_OUT = "islogged_out";
